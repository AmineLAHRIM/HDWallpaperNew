...
//                            Toast.makeText(GIFsDetailsActivity.this, getResources().getString(R.string.gif_already_saved), Toast.LENGTH_SHORT).show();
                        } else {
...
//                            Toast.makeText(GIFsDetailsActivity.this, getResources().getString(R.string.gif_saved), Toast.LENGTH_SHORT).show();
                        }
                        break;
                    default:
...
//                Toast.makeText(GIFsDetailsActivity.this, getResources().getString(R.string.please_try_again), Toast.LENGTH_SHORT).show();
            }
            pDialog.dismiss();
        }
    }
...
//            tv_views.setText(Constant.arrayListGIF.get(position).getTotalViews());
            }

            dbHelper.updateViewGIF(Constant.arrayListGIF.get(p).getId(), Constant.arrayListGIF.get(p).getTotalViews(), Constant.arrayListGIF.get(p).getTotalDownload());
        }
    }
...
//                        Constant.arrayListGIF.get(viewpager.getCurrentItem()).setAverageRate(String.valueOf(rating));
//                        Constant.arrayListGIF.get(viewpager.getCurrentItem()).setTotalRate(String.valueOf(Integer.parseInt(Constant.arrayListGIF.get(viewpager.getCurrentItem()).getTotalRate() + 1)));
                        ratingBar.setRating(rating);
                    }
                } else {
                    Toast.makeText(GIFsDetailsActivity.this, getResources().getString(R.string.server_no_conn), Toast.LENGTH_SHORT).show();
                }
                dialog_rate.dismiss();
